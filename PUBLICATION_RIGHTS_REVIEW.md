...
The repository has no first-party image/font bundle outside dependencies. Do
not change visibility until the repository license is chosen and the
full-history credential finding is resolved.
