...
- Node.js v18+ and npm
- PostgreSQL database (retired-provider)
- WhatsApp Business API access
- Deployed retired-provider Edge Function for AI processing
...
- `retired-provider_URL`: Your retired-provider project URL
- `retired-provider_ANON_KEY`: retired-provider anonymous key
- `retired-provider_SERVICE_ROLE_KEY`: retired-provider service role key (for admin operations)
...
If you already have tables in retired-provider:
...
- Introspect your existing retired-provider database
...
- **AI Service**: Integrates with retired-provider Edge Function
...
- retired-provider JWT authentication for web endpoints
...
1. Call `/auth/send-otp-web` with valid retired-provider token
...
3. **Database connection errors**
   ...
   - Check retired-provider connection pooling settings
